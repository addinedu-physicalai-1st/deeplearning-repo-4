...
@maps_to_action("PPT", "PREV")
class PrevGesture(StaticGesture):
    """PREV 제스처 클래스
    
    이전 슬라이드로 이동하기 위한 제스처입니다.
    ...
    def detect_static(self, landmarks: List[Dict]) -> str:
        ...
        Returns:
            str: "PREV" (인식된 경우) 또는 "NONE" (인식되지 않은 경우)
        """
        # TODO: PREV 제스처 인식 로직 구현
        # 예: 왼쪽으로 손 흔들기, 특정 손가락 제스처 등
