...
@maps_to_action("PPT", "NEXT")
class NextGesture(StaticGesture):
    """NEXT 제스처 클래스
    
    다음 슬라이드로 이동하기 위한 제스처입니다.
    ...
    def detect_static(self, landmarks: List[Dict]) -> str:
        ...
        Returns:
            str: "NEXT" (인식된 경우) 또는 "NONE" (인식되지 않은 경우)
        """
        # TODO: NEXT 제스처 인식 로직 구현
        # 예: 오른쪽으로 손 흔들기, 특정 손가락 제스처 등
