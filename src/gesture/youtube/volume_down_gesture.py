...
@maps_to_action("YOUTUBE", "VOLUME_DOWN")
class VolumeDownGesture(StaticGesture):
    """VOLUME_DOWN 제스처 클래스
    ...
    def detect_static(self, landmarks: List[Dict]) -> str:
        """
        단일 프레임 랜드마크에서 VOLUME_DOWN 제스처 인식
        ...
        Returns:
            str: "VOLUME_DOWN" (인식된 경우) 또는 "NONE" (인식되지 않은 경우)
        """
        # TODO: VOLUME_DOWN 제스처 인식 로직 구현
        # 예: 아래로 손 흔들기, 특정 손가락 제스처 등
